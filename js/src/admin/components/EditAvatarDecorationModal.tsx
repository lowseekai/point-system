...
/**
 * Edit modal for an existing avatar frame. Handles both JSON:API attribute
 * updates AND the optional multipart "replace image" upload in one submit.
 *
 * Attrs:
 *   - deco:    the decoration model being edited
 *   - onSaved? () => void   refresh callback for the parent panel
 */
export default class EditAvatarDecorationModal extends Modal {
  ...
  title() {
    return app.translator.trans('ramon-point-system.admin.avatar.edit_title', {
