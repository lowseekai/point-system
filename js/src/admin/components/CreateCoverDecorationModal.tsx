...
/**
 * Create modal for a new profile cover. Mirrors CreateAvatarDecorationModal
 * but targets the cover-decoration upload endpoint.
 */
export default class CreateCoverDecorationModal extends Modal {
  ...
  title() {
    return app.translator.trans('ramon-point-system.admin.cover.upload_title');
  }
        ...
        <div className="PointSystemAdmin-imageSource">
          <div className="Form-group">
            ...
            <div className="PointSystemAdmin-sourceTabs">
              ...
              <label>
                <input type="radio" name="ps-create-cover-source" checked={this.source === SOURCE_URL} onchange={() => (this.source = SOURCE_URL)} />{' '}
                {ta('source_url')}
              </label>
            </div>
          </div>
